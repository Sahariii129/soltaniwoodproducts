...
/// <summary>
/// Summary description for Cls_SMS
/// </summary>
public class Cls_SMS
{
    public class ClsSend
    {
        ...
        public int FindTxtcount(string unicodeString)
        {
            unicodeString = unicodeString.Replace("\r\n", "a");
            var IsPersian = FindTxtLanguage(unicodeString);
            decimal msgCount = 0;
            ...
            return Convert.ToInt16(msgCount);
        }
    ...
    public class ClsStatus
    {
        public class STC_SMSStatus
        {
            ...
            public STC_SMSStatus(string number, string status)
            {
        ...
        public ArrayList StatusSMS(string UserName, string Password, string IP_Send , string Company, string BatchId)
        {
            try
            {
                ...
                else if (StrXML.Substring(42, 10) != null)
                ...
                //STC_SMSStatus stc_st = new STC_SMSStatus();
                ...
                foreach (XmlNode ndBatch in ndRoot.ChildNodes)
                {
                    foreach (XmlNode ndSMS in ndBatch.ChildNodes)
                    {
                        ...
                        Arr_Res.Add(new STC_SMSStatus(ReceiveNum, Status));
                    }
